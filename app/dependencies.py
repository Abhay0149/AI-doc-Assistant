...
def get_collection_with_access(
    ...
    authorization: Optional[str] = Header(default=None, description="Bearer token de acceso (requerido solo para colecciones privadas)"),
...
def get_optional_collection_from_token(
    authorization: Optional[str] = Header(default=None, description="Bearer token opcional"),
    db: Session = Depends(get_db),
